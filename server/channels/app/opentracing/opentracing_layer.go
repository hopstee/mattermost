...
func (a *OpenTracingAppLayer) SanitizePostListPermalinkForUser(c request.CTX, postList *model.PostList) (*model.PostList, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.SanitizePostListPermalinkForUser")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.SanitizePostListPermalinkForUser(c, postList)
...
func (a *OpenTracingAppLayer) SanitizePostPermalinkForUser(c request.CTX, post *model.Post) (*model.Post, *model.AppError) {
	origCtx := a.ctx
	span, newCtx := tracing.StartSpanWithParentByContext(a.ctx, "app.SanitizePostPermalinkForUser")
	...
	defer span.Finish()
	resultVar0, resultVar1 := a.app.SanitizePostPermalinkForUser(c, post)
